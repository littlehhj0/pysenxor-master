...
while True:
    ...
    if header['frame_counter'] % 2 == 0:
        _col = col2
        _row = row2
    else:
        _col = col1
        _row = row1
    mi48.regwrite('NETD_PIXEL_X', _col)
    #time.sleep(0.06)
    mi48.regwrite('NETD_PIXEL_Y', _row)
    #
